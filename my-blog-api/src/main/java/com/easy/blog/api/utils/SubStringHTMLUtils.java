...
public class SubStringHTMLUtils {
    ...
    public static String subTextHtml(String content, int length, String end) {
        String reg = "<.+?>";
        String subStr = subStringHTML(content, length, end);
    ...
    public static void main(String[] args) {
        ...
        String subHtml = subStringHTML(html, 120, "...");
        System.out.println(subHtml);

        System.out.println(subTextHtml(html, 150, "..."));
    }
